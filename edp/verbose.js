/**
 * @file Verbose Error Codes
 * @notice Copyright (c) 2019 Nomic Labs LLC
 * @summary
 *      We use this to enrich response codes
 *      as it relates to contract integrations
 *      code lists not in use include:
 *          PLUGINS
 *          BUILTIN_TASKS
 *          and other things specific to hardhat but not 'generic'
 * 
 */
module.exports = {
	ERRORS = {
